...
\begin{itemize}
    \item Homepage/Document Sets view (Figure \ref{wire})
    \item Document set view (i.e. documents within the set)
    \item single document view
\end{itemize}
...
\begin{figure}[H]
    ...
    \begin{subfigure}[b]{\linewidth}
        \centering
        \includegraphics[width=0.75\linewidth]{images/wireframes/doc_view.jpg}
