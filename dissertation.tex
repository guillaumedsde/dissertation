...
On June 2nd 2013, in a busy Hongkongese commercial district refuged in one of the 492 rooms of the Mira Hotel, a tens of thousands of neatly organized documents traded hands from a soon to be ex-NSA Employee to two American journalists.
It was not merely the size of the Snowden archive handed over that day that made it ``stunning both in size and scope'', but also that ``it had been
produced by virtually every unit and subdivision within the sprawling agency, and [...] closely aligned foreign intelligence agencies'' \autocite[77]{greenwaldNoPlaceHide2014}.
...
Despite this, the many hands that worked on the Snowden archive were only confronted with a task only a fraction the scale of today's sensitivity reviewers.

In the UK, the Freedom of Information Act \autocite{FreedomInformationAct2000} create a public ``right of access'' by request to information held by public authorities except for exemptions stated by the act
