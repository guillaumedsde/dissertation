...
For instance, Foxit PhantomPDF is another well known PDF editor that implements a strikingly similar context menu (Appendix \ref{fig:foxit_menu}) also allows for document wide redaction of a text selection (Appendix \ref{fig:foxit_redact_all}), something which Adobe implement quite poorly.
